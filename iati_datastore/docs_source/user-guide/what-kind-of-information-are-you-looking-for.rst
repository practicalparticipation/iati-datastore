...
The `Datastore Query Builder </#get-the-data>`__ will help you to build selections that you can download in CSV format which will open in your chosen spreadsheet application.
